...
1. **Clone the repository**
   ```console
   git clone https://github.com/Monu/QuickShow.git
   cd QuickShow
   ```
...
This project is licensed under the MIT License. See the [LICENSE](https://github.com/Monu/QuickShow/blob/main/LICENSE) file for details.
